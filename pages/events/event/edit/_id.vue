...
export default {
  ...
  methods: {
    async getEvent() {
      await axios.get(API_URL + '/api/get-event/' + this.$route.params.id, {
        headers: HEADERS(this.$auth.getToken('password_grant'))
      }).then(res => {
        this.name = res.data.name
        this.date = res.data.event_date
        this.location = res.data.location
        this.imageData = res.data.image
        this.eventTime = res.data.time
        this.description = res.data.description
        this.inviteFriendsOnly = res.data.open_invatation
        this.inviteOnly = res.data.invite_only
      })
    },
    chooseImage() {
    ...
    onSubmit() {
      ...
      axios.post(API_URL + '/api/update-event', form, {
				headers: HEADERS(this.$auth.getToken('password_grant'))
      })
      .then(response => {
        this.loading = false
