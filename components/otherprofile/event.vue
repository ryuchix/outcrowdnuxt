<template>
  <v-app class="events" v-if="!loading">
    <div class="d-flex justify-space-between">
      ...
      <div @click="$router.push({path: '/profile/event/ongoing/' + $route.params.id})" class="event-status-see-all" v-ripple v-if="currently != null && currently.length > 1">See all</div>
    </div>
    <div class="hosting">
    ...
    <div class="d-flex justify-space-between">
      ...
      <div @click="$router.push({path: '/profile/event/upcoming/' + $route.params.id})" class="event-status-see-all" v-ripple v-if="upcoming != null && upcoming.length > 1">See all</div>
    </div>
    <div class="hosting">
      <div class="hosting-event">
        <v-card
    ...
    <div class="d-flex justify-space-between">
      ...
      <div @click="$router.push({path: '/profile/event/interested/' + $route.params.id})" class="event-status-see-all" v-ripple v-if="myinterested != null && myinterested.length > 1">See all</div>
    </div>
    <div class="hosting">
      <div class="hosting-event">
        <v-card
...
export default {
  ...
  async fetch() {
    this.loading = true;
    await axios.get(API_URL + '/api/user-home-events/' + this.userid, {
